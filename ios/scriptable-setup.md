...
That is the whole Shortcut. `Get Text from Input` is required because raw Share Sheet data is not readable by Scriptable. The script opens Safari directly.
